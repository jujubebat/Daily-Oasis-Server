# Generated by Django 2.2.4 on 2019-09-09 14:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delegateTitle', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('num', models.AutoField(primary_key=True, serialize=False)),
                ('preference_num', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.Title')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('num', models.AutoField(primary_key=True, serialize=False)),
                ('preference_num', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.Preference')),
                ('user_num', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.Activity')),
            ],
        ),
        migrations.AddField(
            model_name='user',
